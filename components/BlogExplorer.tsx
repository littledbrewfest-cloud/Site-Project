    ...
    <div className="space-y-12">
      ...
      <div className="bg-white dark:bg-[#0c1222] p-5 sm:p-7 rounded-3xl border border-slate-200 dark:border-slate-800 shadow-md dark:shadow-xl space-y-5">
        <div className="flex flex-col sm:flex-row gap-3 items-stretch sm:items-center justify-between">
          <div className="relative flex-1">
            ...
            <input
              ...
              className="w-full pl-11 pr-10 py-3 bg-slate-50 dark:bg-slate-950/80 border border-slate-200 dark:border-slate-800 rounded-2xl text-slate-900 dark:text-white placeholder-slate-400 dark:placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-amber-500/50 focus:border-amber-500/50 transition-all text-sm font-medium"
            />
            {searchQuery && (
              <button
                onClick={() => setSearchQuery("")}
                className="absolute right-3.5 top-1/2 -translate-y-1/2 text-xs font-bold text-slate-400 hover:text-slate-600 dark:hover:text-white p-1"
              >
                ✕
              </button>
            )}
        ...
        <div className="flex items-center gap-2 overflow-x-auto pb-2 scrollbar-none text-xs sm:text-sm pt-1">
          <span className="flex items-center gap-1 font-bold text-slate-500 dark:text-slate-400 pl-1 mr-1 text-xs uppercase tracking-wider font-mono">
          ...
          <button
            ...
            className={`px-4 py-2 rounded-2xl font-bold transition-all whitespace-nowrap text-xs ${
              selectedCategory === "All"
                ...
                : "bg-slate-100 dark:bg-slate-900/90 text-slate-700 dark:text-slate-300 hover:bg-slate-200 dark:hover:bg-slate-800 border border-slate-200 dark:border-slate-800"
            }`}
          >
